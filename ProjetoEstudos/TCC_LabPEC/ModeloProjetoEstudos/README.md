...
2. Ler cuidadosamente o documento `ModeloProjetoEstudosTCC_LabPEC`

3. Ler os documentos `ModeloProjetoEstudos_Exemplo01.docx`, `ModeloProjetoEstudos_Exemplo01.docx` e `ModeloProjetoEstudos_Exemplo03.pdf` da pasta `Exemplos` e verificar como as instruções do documento `ModeloProjetoEstudosTCC_LabPEC` foram transformadas em texto.

4. A partir do modelo, salvar um documento `ModeloProjetoEstudosTCC_LabPEC_SEUNOME`
